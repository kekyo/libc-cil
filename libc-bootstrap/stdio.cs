...
namespace C
{
    ...
    public static partial class text
    {
        ...
        {
            var ap = new __va_list_impl(__arglist);
        ...
        public static unsafe int sprintf(sbyte* buf, sbyte* fmt, __arglist) =>
            vsprintf(buf, fmt, new __va_list_impl(__arglist));

        // int fprintf(FILE *fp, char *fmt, ...);
        public static unsafe int fprintf(FILE* fp, sbyte* fmt, __arglist) =>
            vfprintf(fp, fmt, new __va_list_impl(__arglist));
